            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
                ...
                <div className="flex items-start mb-8 gap-6">
                    ...
                    <p className="text-lg text-muted-foreground">
                        ...
                        launch vehicles in the EU funded H2020 project RETALT. The CFD4SALTO
                        project will be performed in collaboration with the Horizon Europe
                        funded project SALTO – reuSable strAtegic space Launcher Technologies &
                        Operations.
                    </p>
                </div>
                <p className="text-lg text-muted-foreground">
                    The CFD4SALTO project is lead by DLR in Cologne.
                    CFS Engineering will perform CFD computations for the generation of the aerodynamic databases for the SALTO T3 Vehicle. In addition CFS Engineering will perform CFD computations to support the Wind tunnel testing at DLR in Cologne, as well perform CFD simulations to extrapolate wind tunnel data to flight conditions. The project will run for 3 years.
                </p>

                {/* Related Publications as a nested expander (closed by default) */}
                <div className="mt-6">
                    <Accordion type="single" collapsible>
                        <AccordionItem value="pubs">
                            <AccordionTrigger>Related Publications</AccordionTrigger>
                            <AccordionContent>
                                <ReusablePublications />
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                </div>
        ...
        <div className="mt-3 space-y-3">
            {publications.map((p) => (
                <div key={p.id} className="border rounded p-3 bg-white">
                    ...
                    <p className="text-sm text-muted-foreground">{p.venue} {p.details}</p>
